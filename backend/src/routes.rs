...
pub fn configure(app: &mut web::ServiceConfig, app_state: web::Data<AppState>) {
    ...
    app.app_data(app_state.clone())
        ...
        .route(
            "/api/ai/provider/list",
            web::post().to(handlers::list_ai_providers),
        )
        .route(
            "/api/ai/provider/presets",
            web::post().to(handlers::list_provider_presets),
        )
        .route(
            "/api/ai/provider/create",
            web::post().to(handlers::create_ai_provider),
        )
        .route(
            "/api/ai/provider/update",
            web::post().to(handlers::update_ai_provider),
        )
        .route(
            "/api/ai/provider/delete",
            web::post().to(handlers::delete_ai_provider),
        )
        .route(
            "/api/ai/provider/fetch_models",
            web::post().to(handlers::fetch_ai_models),
        )
        .route(
            "/api/ai/model/delete",
            web::post().to(handlers::delete_ai_model),
        )
        .route(
            "/api/ai/chat/list",
            web::post().to(handlers::ai_chat_list),
        )
        .route(
            "/api/ai/chat/create",
            web::post().to(handlers::ai_chat_create),
        )
        .route(
            "/api/ai/chat/rename",
            web::post().to(handlers::ai_chat_rename),
        )
        .route(
            "/api/ai/chat/delete",
            web::post().to(handlers::ai_chat_delete),
        )
        .route(
            "/api/ai/chat/messages",
            web::post().to(handlers::ai_chat_messages),
        )
        .route(
            "/api/ai/chat/send",
            web::post().to(handlers::ai_chat_send),
        )
        .route(
            "/api/ai/chat/page_query_result",
            web::post().to(handlers::ai_chat_page_query_result),
        )
        .route(
            "/api/ai/chat/image",
            web::get().to(handlers::ai_chat_image),
        )
        .route(
            "/api/user/set_ai_chat_path",
            web::post().to(handlers::set_ai_chat_path),
        )
        .route(
            "/api/ebook/test_pdf",
            web::post().to(handlers::test_pdf),
        )
        .route(
            "/api/user/set_ebook_path",
            web::post().to(handlers::set_ebook_path),
        )
        .route(
            "/api/ebook/config/get",
            web::post().to(handlers::ebook_get_config),
        )
        .route(
            "/api/ebook/config/set",
            web::post().to(handlers::ebook_set_config),
        )
        .route(
            "/api/ebook/shelf/list",
            web::post().to(handlers::ebook_shelf_list),
        )
        .route(
            "/api/ebook/shelf/add",
            web::post().to(handlers::ebook_shelf_add),
        )
        .route(
            "/api/ebook/shelf/remove",
            web::post().to(handlers::ebook_shelf_remove),
        )
        .route(
            "/api/ebook/shelf/relink",
            web::post().to(handlers::ebook_shelf_relink),
        )
        .route(
            "/api/ebook/shelf/cover",
            web::post().to(handlers::ebook_shelf_cover),
        )
        .route(
            "/api/ebook/scan/discover",
            web::post().to(handlers::ebook_scan_discover),
        )
        .route(
            "/api/ebook/scan/progress",
            web::post().to(handlers::ebook_scan_progress),
        )
        .route(
            "/api/ebook/category/list",
            web::post().to(handlers::ebook_category_list),
        )
        .route(
            "/api/ebook/category/add",
            web::post().to(handlers::ebook_category_add),
        )
        .route(
            "/api/ebook/category/rename",
            web::post().to(handlers::ebook_category_rename),
        )
        .route(
            "/api/ebook/category/remove",
            web::post().to(handlers::ebook_category_remove),
        )
        .route(
            "/api/ebook/category/move-book",
            web::post().to(handlers::ebook_category_move_book),
        )
        .route(
            "/api/ebook/book/meta",
            web::post().to(handlers::ebook_book_meta),
        )
        .route(
            "/api/ebook/book/download",
            web::post().to(handlers::ebook_book_download),
        )
        .route(
            "/api/ebook/preview/get",
            web::post().to(handlers::ebook_preview_get),
        )
        .route(
            "/api/ebook/progress/save",
            web::post().to(handlers::ebook_progress_save),
        )
        .route(
            "/api/ebook/progress/get",
            web::post().to(handlers::ebook_progress_get),
        )
        .route(
            "/api/ebook/bookmark/add",
            web::post().to(handlers::ebook_bookmark_add),
        )
        .route(
            "/api/ebook/bookmark/list",
            web::post().to(handlers::ebook_bookmark_list),
        )
        .route(
            "/api/ebook/bookmark/remove",
            web::post().to(handlers::ebook_bookmark_remove),
        )
